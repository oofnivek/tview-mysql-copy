...
func ShowHome(app *tview.Application, prefs *config.Preferences, onManageConnections func(), onManagePresets func(), onRunPresets func(), onToggleTheme func()) tview.Primitive {
	...
	list.AddItem("Run Preset(s)", "", 0, nil)
